  ...
  methods: {
    ...
    loadData(pagination, filters, sorter) {
      ...
      const parameter = Object.assign(
        {
          skipCount: (pageParam.pageNo - 1) * pageParam.pageSize,
          sortField: sorter && sorter.field ? sorter.field : undefined,
          sortOrder: sorter && sorter.order ? sorter.order : undefined,
        }, {
          ...filters
        }
      )
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          this.localPagination = Object.assign({}, this.localPagination, {
            current: pageParam.pageNo, // 返回结果中的当前分页数
