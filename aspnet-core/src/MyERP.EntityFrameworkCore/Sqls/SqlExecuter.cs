...
namespace MyERP.Sqls
{
    public class SqlExecuter : ISqlExecuter, ITransientDependency
    {
        private readonly IDbContextProvider<MyERPDbContext> _dbContextProvider;

        public SqlExecuter(IDbContextProvider<MyERPDbContext> dbContextProvider)
        {
        ...
        /// <returns></returns>
        public List<T> SqlQuery<T>(string sql, Dictionary<string, object> parameters) where T : class, new()
        {
        ...
        /// <param name="parameters">要应用于 SQL 查询字符串的参数</param>
        /// <returns></returns>
        public DataTable SqlQuery(string sql, Dictionary<string, object> parameters) 
        {
